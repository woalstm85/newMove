...
class SpecialMoveTypeModal extends StatefulWidget {
  const SpecialMoveTypeModal({super.key});

  @override
  _SpecialMoveTypeModalState createState() => _SpecialMoveTypeModalState();
}

class _SpecialMoveTypeModalState extends State<SpecialMoveTypeModal> {
  ...
  Future<void> _loadSelectedMoveType() async {
    ...
    setState(() {
      selectedMoveType = prefs.getString('selectedSpecialMoveType');
    });
  }
  ...
  Future<void> _saveSelectedMoveType(String type) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('selectedSpecialMoveType', type);
  }
